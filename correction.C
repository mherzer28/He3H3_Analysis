...
void correction(){
    ...
    TFile *result = new TFile("/Users/matthias/alice/Master/Makros/result/correction/correctionYield.root", "UPDATE");
    for (int particle = 0; particle < nParticles; particle++){
    ...
    TFile *resultHe = new TFile("/Users/matthias/alice/Master/Makros/result/correction/correctionYieldHe.root", "UPDATE");
    for (int particle = 0; particle < nParticles; particle++){
    ...
    TFile *result2 = new TFile("/Users/matthias/alice/Master/Makros/result/correction/correction.root", "UPDATE");
    ...
    TFile *resultCorrection = new TFile("/Users/matthias/alice/Master/Makros/result/correction/correctionresult.root", "recreate");
    ...
    c->SaveAs("/Users/matthias/alice/Master/Makros/result/Plots/H3/Korrekturen/corryieldH3.pdf");
    ...
    c2->SaveAs("/Users/matthias/alice/Master/Makros/result/Plots/He3/Korrekturen/corryieldHe.pdf");
    ...
    //hCorr[2]->Scale(1./2.);
	//hCorr[2]->Draw("SAME");
    canYield->SaveAs(Form("/Users/matthias/alice/Master/Makros/result/Plots/H3/Korrekturen/ratiocorryieldH3.pdf"));
    canYield->SaveAs(Form("/Users/matthias/alice/Master/Makros/result/Plots/H3/Korrekturen/ratiocorryieldH3.root"));
	canYield->SaveAs(Form("/Users/matthias/alice/Master/Makros/result/Plots/H3/Korrekturen/ratiocorryieldH3.C"));
    ...
    //hCorrHe[2]->Scale(1./2.);
	//hCorrHe[2]->Draw("SAME");
    canYieldHe->SaveAs(Form("/Users/matthias/alice/Master/Makros/result/Plots/He3/Korrekturen/ratiocorryieldHe.pdf"));
    canYieldHe->SaveAs(Form("/Users/matthias/alice/Master/Makros/result/Plots/He3/Korrekturen/ratiocorryieldHe.root"));
	canYieldHe->SaveAs(Form("/Users/matthias/alice/Master/Makros/result/Plots/He3/Korrekturen/ratiocorryieldHe.C"));
