...
//=========  (Mon Jun 17 15:59:46 2024) by ROOT version 6.30/01
   ...
   fitfunc6->SetParError(0,7.029279);
   fitfunc6->SetParLimits(0,0,0);
   fitfunc6->SetParameter(1,1.974702);
   fitfunc6->SetParError(1,0.005626301);
   fitfunc6->SetParLimits(1,0,0);
   fitfunc6->SetParameter(2,-0.05978072);
   fitfunc6->SetParError(2,0.004999507);
