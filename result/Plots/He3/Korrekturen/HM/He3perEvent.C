...
//=========  (Fri Aug 23 10:49:10 2024) by ROOT version 6.30/01
   ...
   yieldCombinedPerEventHe__24->SetBinContent(1,1.728166e-06);
   yieldCombinedPerEventHe__24->SetBinContent(2,9.106794e-07);
   yieldCombinedPerEventHe__24->SetBinContent(3,6.621541e-07);
   yieldCombinedPerEventHe__24->SetBinError(1,1.376163e-07);
   yieldCombinedPerEventHe__24->SetBinError(2,5.815596e-08);
   yieldCombinedPerEventHe__24->SetBinError(3,4.477553e-08);
   yieldCombinedPerEventHe__24->SetEntries(447.9872);
