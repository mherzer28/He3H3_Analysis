...
//=========  (Fri Aug 23 10:49:10 2024) by ROOT version 6.30/01
   ...
   combinedCanvasCorr->Range(1.25,-6.976259,2.75,-5.539517);
   ...
   yieldCombinedPerEventHe__25->SetBinContent(1,9.89489e-07);
   yieldCombinedPerEventHe__25->SetBinContent(2,5.182783e-07);
   yieldCombinedPerEventHe__25->SetBinContent(3,3.231901e-07);
   yieldCombinedPerEventHe__25->SetBinError(1,1.051218e-07);
   yieldCombinedPerEventHe__25->SetBinError(2,4.11849e-08);
   yieldCombinedPerEventHe__25->SetBinError(3,2.912364e-08);
   yieldCombinedPerEventHe__25->SetEntries(246.5915);
   ...
   yieldCombinedPerEventHe__26->SetBinContent(1,7.386772e-07);
   yieldCombinedPerEventHe__26->SetBinContent(2,3.924012e-07);
   yieldCombinedPerEventHe__26->SetBinContent(3,3.38964e-07);
   yieldCombinedPerEventHe__26->SetBinError(1,8.88125e-08);
   yieldCombinedPerEventHe__26->SetBinError(2,4.105995e-08);
   yieldCombinedPerEventHe__26->SetBinError(3,3.400973e-08);
   yieldCombinedPerEventHe__26->SetEntries(201.3957);
