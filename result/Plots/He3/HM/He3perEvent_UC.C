...
//=========  (Sun Jul  7 14:19:21 2024) by ROOT version 6.30/01
   ...
   yieldCombinedPerEventHe3_uncorrected__5->SetBinContent(1,1.647477e-07);
   yieldCombinedPerEventHe3_uncorrected__5->SetBinContent(2,2.578659e-07);
   yieldCombinedPerEventHe3_uncorrected__5->SetBinContent(3,2.292142e-07);
   yieldCombinedPerEventHe3_uncorrected__5->SetBinError(1,1.298394e-08);
   yieldCombinedPerEventHe3_uncorrected__5->SetBinError(2,1.624403e-08);
   yieldCombinedPerEventHe3_uncorrected__5->SetBinError(3,1.531502e-08);
