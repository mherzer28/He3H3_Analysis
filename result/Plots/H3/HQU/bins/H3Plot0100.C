...
//=========  (Fri Aug 23 16:16:59 2024) by ROOT version 6.30/01
   ...
   pt10->Range(3.8,-1.266311,11.8,8.225424);
   pt10->SetFillColor(0);
   ...
   fitfunc4->SetChisquare(1.53903e-06);
   fitfunc4->SetNDF(0);
   ...
   fitfunc4->SetParameter(0,4.561758);
   fitfunc4->SetParError(0,2.471445);
   fitfunc4->SetParLimits(0,0,0);
   fitfunc4->SetParameter(1,8.032365);
   fitfunc4->SetParError(1,0.08284267);
   fitfunc4->SetParLimits(1,0,0);
   fitfunc4->SetParameter(2,0.1850651);
   fitfunc4->SetParError(2,0.09112906);
   fitfunc4->SetParLimits(2,0,0);
   fitfunc4->SetParameter(3,-4.417065);
   fitfunc4->SetParError(3,12.4452);
   fitfunc4->SetParLimits(3,0,0);
   fitfunc4->SetParameter(4,0.467868);
   fitfunc4->SetParError(4,1.318714);
