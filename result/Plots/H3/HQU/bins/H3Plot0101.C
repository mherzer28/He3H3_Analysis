...
//=========  (Fri Aug 23 16:16:59 2024) by ROOT version 6.30/01
   ...
   histTOFfit0101__5->SetBinContent(0,17);
   ...
   histTOFfit0101__5->SetBinContent(14,31);
   ...
   histTOFfit0101__5->SetBinContent(26,5);
   histTOFfit0101__5->SetBinError(0,4.123106);
   ...
   histTOFfit0101__5->SetBinError(14,5.567764);
   ...
   histTOFfit0101__5->SetBinError(26,2.236068);
   histTOFfit0101__5->SetEntries(213);
   ...
   fitfunc5->SetChisquare(10.84569);
   fitfunc5->SetNDF(17);
   ...
   fitfunc5->SetParameter(0,50.55419);
   fitfunc5->SetParError(0,5.520922);
   fitfunc5->SetParLimits(0,0,0);
   fitfunc5->SetParameter(1,7.958648);
   fitfunc5->SetParError(1,0.02492466);
   fitfunc5->SetParLimits(1,0,0);
   fitfunc5->SetParameter(2,0.2664565);
   fitfunc5->SetParError(2,0.02026882);
   fitfunc5->SetParLimits(2,0,0);
   fitfunc5->SetParameter(3,1.320905);
   fitfunc5->SetParError(3,0.7915319);
   fitfunc5->SetParLimits(3,0,0);
   fitfunc5->SetParameter(4,-0.09410988);
   fitfunc5->SetParError(4,0.1009551);
