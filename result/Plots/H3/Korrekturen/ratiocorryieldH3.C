...
//=========  (Sat Jun  8 18:30:23 2024) by ROOT version 6.30/01
...
// ------------>Primitives in pad: pad1hCorr0
   ...
   pad1hCorr0__0->Draw();
   pad1hCorr0__0->cd();
   pad1hCorr0__0->Range(1.183133,0.01,2.628916,2338.208);
   ...
   hshCorr0_stack_1->SetMaximum(2104.388);
...
// ------------>Primitives in pad: pad2hCorr0
   ...
   pad2hCorr0__1->Draw();
   pad2hCorr0__1->cd();
   pad2hCorr0__1->Range(1.183133,0.3018448,2.628916,1.178909);
