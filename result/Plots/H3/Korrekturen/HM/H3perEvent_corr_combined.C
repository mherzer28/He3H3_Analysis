...
//=========  (Mon Jul  8 14:31:47 2024) by ROOT version 6.30/01
   ...
   combinedCanvasCorrH3->Range(1.25,1.831185e-07,2.75,1.059611e-06);
   ...
   combinedCanvasCorrH3->SetFrameBorderMode(0);
   Double_t xAxis20[4] = {1.4, 1.8, 2.2, 2.6}; 
   
   TH1D *yieldCombinedPerEvent0__20 = new TH1D("yieldCombinedPerEvent0__20","",3, xAxis20);
   yieldCombinedPerEvent0__20->SetBinContent(1,8.454889e-07);
   yieldCombinedPerEvent0__20->SetBinContent(2,5.108943e-07);
   yieldCombinedPerEvent0__20->SetBinContent(3,3.698493e-07);
   yieldCombinedPerEvent0__20->SetBinError(1,9.30828e-08);
   yieldCombinedPerEvent0__20->SetBinError(2,6.360276e-08);
   yieldCombinedPerEvent0__20->SetBinError(3,6.728142e-08);
   yieldCombinedPerEvent0__20->SetEntries(172.8818);
   ...
   Double_t xAxis21[4] = {1.4, 1.8, 2.2, 2.6}; 
   
   TH1D *yieldCombinedPerEvent1__21 = new TH1D("yieldCombinedPerEvent1__21","",3, xAxis21);
   yieldCombinedPerEvent1__21->SetBinContent(1,5.938013e-07);
   yieldCombinedPerEvent1__21->SetBinContent(2,4.751127e-07);
   yieldCombinedPerEvent1__21->SetBinContent(3,3.305449e-07);
   yieldCombinedPerEvent1__21->SetBinError(1,6.956605e-08);
   yieldCombinedPerEvent1__21->SetBinError(2,5.781662e-08);
   yieldCombinedPerEvent1__21->SetBinError(3,7.310901e-08);
   yieldCombinedPerEvent1__21->SetEntries(144.7821);
