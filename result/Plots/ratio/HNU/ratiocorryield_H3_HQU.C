...
#endif
void ratiocorryield_H3_HQU()
{
//=========Macro generated from canvas: CorrYield/corr yield bin counting
//=========  (Wed Aug 28 15:41:25 2024) by ROOT version 6.30/01
...
// ------------>Primitives in pad: pad1hCorr0
   ...
   pad1hCorr0__0->Draw();
   pad1hCorr0__0->cd();
   pad1hCorr0__0->Range(1.028916,0.01,2.836145,532975.1);
   ...
   hshCorr0_stack_1->SetMaximum(479677.6);
   ...
   hCorr0_stack_1->SetBinContent(1,368982.8);
   hCorr0_stack_1->SetBinContent(2,124022.8);
   hCorr0_stack_1->SetBinContent(3,360104.3);
   hCorr0_stack_1->SetBinError(1,232034);
   hCorr0_stack_1->SetBinError(2,24335.29);
   hCorr0_stack_1->SetBinError(3,98816.64);
   hCorr0_stack_1->SetEntries(11.33697);
   ...
   hCorr1_stack_2->SetBinContent(1,25927.54);
   hCorr1_stack_2->SetBinContent(2,36661.14);
   hCorr1_stack_2->SetBinContent(3,89358.65);
   hCorr1_stack_2->SetBinError(1,11770.89);
   hCorr1_stack_2->SetBinError(2,3608.46);
   hCorr1_stack_2->SetBinError(3,13229.69);
   hCorr1_stack_2->SetEntries(70.69205);
...
// ------------>Primitives in pad: pad2hCorr0
   ...
   pad2hCorr0__1->Draw();
   pad2hCorr0__1->cd();
   pad2hCorr0__1->Range(1.028916,-0.1622205,2.836145,0.3785145);
   ...
   histRatiohCorr0__1->SetBinContent(1,0.07026762);
   histRatiohCorr0__1->SetBinContent(2,0.2956);
   histRatiohCorr0__1->SetBinContent(3,0.2481466);
   histRatiohCorr0__1->SetBinError(1,0.0544997);
   histRatiohCorr0__1->SetBinError(2,0.06488994);
   histRatiohCorr0__1->SetBinError(3,0.07737271);
   histRatiohCorr0__1->SetEntries(28.63221);
